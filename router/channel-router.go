...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/upstream_http_config", permission: authz.ChannelRead, handler: controller.GetChannelUpstreamHTTPConfig},
	...
	{method: http.MethodGet, path: "/upstream_warmup/status", permission: authz.ChannelRead, handler: controller.GetUpstreamWarmupStatus},
}
