...
type Task struct {
	...
	BillingStatus    string                `json:"-" gorm:"type:varchar(20);not null;default:''"`
	RefundedQuota    int                   `json:"-" gorm:"not null;default:0"`
	BillingUpdatedAt int64                 `json:"-" gorm:"not null;default:0"`
...
type TaskBillingContext struct {
	...
	GroupRatioResolved        bool               `json:"group_ratio_resolved,omitempty"` // true 表示 GroupRatio 是提交时冻结的最终倍率
	GroupRatioSource          string             `json:"group_ratio_source,omitempty"`
	UserGroupRatioOverride    float64            `json:"user_group_ratio_override,omitempty"`
	HasUserGroupRatioOverride bool               `json:"has_user_group_ratio_override,omitempty"`
