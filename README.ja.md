...
| `STREAMING_MAX_BUFFER_SIZE` | 上流 SSE の1イベントあたりの最大サイズ（バイト）。1–128 MiB の範囲の整数 MiB で指定 | `16777216` |
| `STREAM_SCANNER_MAX_BUFFER_MB` | 旧環境向けの上流 SSE 1イベント最大サイズ互換設定（MiB、1–128） | 未設定 |
