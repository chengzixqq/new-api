...
const (
	redisRateLimitKeyPrefix = "rateLimit:sw:"
	redisRateLimitTimeout   = time.Second
...
func redisIPRateLimitKey(mark, ip string) string {
	return redisRateLimitKeyPrefix + mark + ":ip:" + ip
}
