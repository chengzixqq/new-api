...
| `STREAMING_MAX_BUFFER_SIZE` | Taille maximale d’un événement SSE amont en octets ; doit correspondre à un nombre entier de Mio entre 1 et 128 | `16777216` |
| `STREAM_SCANNER_MAX_BUFFER_MB` | Paramètre de compatibilité pour la taille maximale d’un événement SSE amont en Mio (1–128) | non défini |
