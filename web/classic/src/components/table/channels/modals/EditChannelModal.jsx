    ...
    if (success) {
      ...
      if (data.settings) {
        try {
          ...
          data.upstream_trace_enabled =
            parsedSettings.upstream_trace_enabled === true;
          data.force_http1 = parsedSettings.force_http1 === true;
          ...
          data.upstream_trace_enabled = false;
          data.force_http1 = false;
  ...
  const submit = async () => {
    ...
    if (localInputs.type === 1 || localInputs.type === 14) {
      ...
      if (localInputs.type === 14) {
        ...
        settings.cowork_adaptive_thinking_fix =
          localInputs.cowork_adaptive_thinking_fix === true;
      }
    }
    if (localInputs.type !== 14 && 'cowork_adaptive_thinking_fix' in settings) {
    ...
    settings.upstream_trace_enabled =
      localInputs.upstream_trace_enabled === true;

    settings.force_http1 = localInputs.force_http1 === true;
    ...
    delete localInputs.upstream_trace_enabled;
    delete localInputs.force_http1;
              ...
              <div className='space-y-4'>
                ...
                <div className='py-3 border-b border-gray-100'>
                  ...
                  {inputs.type === 14 && (
                    <>
                      ...
                      />
                      <Form.Switch
                        field='cowork_adaptive_thinking_fix'
                        label={t('Cowork adaptive thinking signature fix')}
                        checkedText={t('开')}
                        uncheckedText={t('关')}
                        onChange={(value) =>
                          handleChannelOtherSettingsChange(
                        ...
                        extraText={t(
                          '当 Claude Desktop / Cowork 使用 adaptive thinking 出现 Invalid signature in thinking block 时启用',
                        )}
                      />
                    </>
                  )}
                ...
                <div className='pt-3'>
                  ...
                  <Form.Switch
                    ...
                    extraText={t(
                      '定时预热到该渠道上游的 TCP/TLS/HTTP2 连接，降低真实请求首字节延迟；不计费、失败仅记日志，仅对该渠道生效。',
                    )}
                  />

                  <Form.Switch
                    field='upstream_trace_enabled'
                    label={t('上游请求埋点')}
                    checkedText={t('开')}
                    uncheckedText={t('关')}
                    onChange={(value) =>
                    ...
                    extraText={t(
                      '对该渠道采集上游请求分段耗时写入日志详情（仅管理员可见），即使全局埋点开关关闭也对该渠道生效，按全局采样率采样。',
                    )}
                  />
                  ...
                  <Form.Switch
                    ...
                    uncheckedText={t('关')}
                    onChange={(value) =>
                      handleChannelOtherSettingsChange('force_http1', value)
                    }
                    extraText={t(
                      '对上游请求禁用 HTTP/2。当上游在长时间流式传输（如 4K 图片生成）中返回 HTTP/2 RST_STREAM 错误时启用。',
                    )}
                  />
