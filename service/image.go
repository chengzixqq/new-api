...
func GetImageFromUrl(url string) (mimeType string, data string, err error) {
	return GetImageFromUrlWithContext(context.Background(), url)
}
...
func DecodeUrlImageData(imageUrl string) (image.Config, string, error) {
	return DecodeUrlImageDataWithContext(context.Background(), imageUrl)
}

func DecodeUrlImageDataWithContext(ctx context.Context, imageUrl string) (image.Config, string, error) {
	response, err := DoDownloadRequestWithContext(ctx, imageUrl)
	if err != nil {
