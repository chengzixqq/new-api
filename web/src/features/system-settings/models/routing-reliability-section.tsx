...
const routingReliabilitySchema = z
  .object({
    responses_empty_output_guard_enabled: z.boolean(),
...
type RoutingReliabilitySectionProps = {
  defaultValues: {
    responses_empty_output_guard_enabled: boolean
    RetryTimes: number
...
const buildFormDefaults = (
  ...
  responses_empty_output_guard_enabled:
    defaults.responses_empty_output_guard_enabled ?? false,
...
const normalizeFormValues = (
  ...
  responses_empty_output_guard_enabled:
    values.responses_empty_output_guard_enabled,
          ...
          <div className='flex min-w-0 flex-col gap-4'>
            ...
            <div className='grid min-w-0 gap-6 xl:grid-cols-[minmax(12rem,24rem)_minmax(0,1fr)]'>
              <FormField
                ...
                name='responses_empty_output_guard_enabled'
                render={({ field }) => (
                  <SettingsSwitchItem>
                    <SettingsSwitchContent>
                      <FormLabel>{t('Responses empty output guard')}</FormLabel>
                      <FormDescription>
                        {t(
                          'Retry completed Responses API requests that contain no visible output. Disabled by default.'
                        )}
                      </FormDescription>
                    </SettingsSwitchContent>
                    <FormControl>
