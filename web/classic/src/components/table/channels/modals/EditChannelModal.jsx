                ...
                <div className='py-3 border-b border-gray-100'>
                  ...
                  {inputs.type === 14 && (
                    <>
                      ...
                      <Form.Switch field='cowork_adaptive_thinking_fix' label={t('Cowork adaptive thinking signature fix')} checkedText={t('开')} uncheckedText={t('关')} onChange={(value) => handleChannelOtherSettingsChange('cowork_adaptive_thinking_fix', value)} extraText={t('当 Claude Desktop / Cowork 使用 adaptive thinking 出现 Invalid signature in thinking block 时启用')} />
                    </>
                  )}
                </div>
