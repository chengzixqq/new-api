...
function hasAdvancedSettingsValues(values: ChannelFormValues): boolean {
  return Boolean(
    ...
    values.responses_empty_output_guard !== 'inherit' ||
    values.max_retries !== undefined ||
                        ...
                        >
                          ...
                          >
                            <div className='divide-border space-y-0 divide-y border-y'>
                              ...
                              <FormField
                                control={form.control}
                                name='responses_empty_output_guard'
                                render={({ field }) => (
                                  <FormItem className='px-4 py-3'>
                                    <FormLabel>
                                      {t('Responses empty output guard')}
                                    </FormLabel>
                                    <Select
                                      items={[
                                        {
                                          value: 'inherit',
                                          label: t('Inherit system setting'),
                                        },
                                        {
                                          value: 'on',
                                          label: t('Force on'),
                                    ...
                                    <FormDescription>
                                      {t(
                                        'Choose whether this channel retries completed Responses API requests with no visible output.'
                                      )}
                                    </FormDescription>
                                    <FormMessage />
                                  </FormItem>
                              ...
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem className='px-4 py-3'>
                                    ...
                                    <FormDescription>
                                      {t(
                                        'Leave empty to inherit the system retry count. Set 0 to disable retries for this channel. Allowed range: 0-10.'
                                      )}
                                    </FormDescription>
                                    <FormMessage />
                                  </FormItem>
